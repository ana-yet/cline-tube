export const metadata = {
  ...
  description: "CineTube Terms of Service — rules and guidelines for using our platform.",
};
      ...
      <div className="prose prose-neutral dark:prose-invert max-w-none space-y-8">
        ...
        <section>
          ...
          <ul className="list-disc list-inside text-muted-foreground space-y-2 ml-4">
            ...
            <li>You grant CineTube a license to display and distribute your content on the platform.</li>
            <li>You agree not to submit false, misleading, or plagiarized content.</li>
            <li>Content containing spoilers should be marked with a spoiler warning.</li>
            <li>We reserve the right to moderate, edit, or remove content that violates our guidelines.</li>
          </ul>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-3">4. Subscriptions & Billing</h2>
          <p className="text-muted-foreground leading-relaxed mb-3">
        ...
        <section>
          ...
          <p className="text-muted-foreground leading-relaxed">
            CineTube is provided &ldquo;as is&rdquo; without warranties of any kind. We are not
